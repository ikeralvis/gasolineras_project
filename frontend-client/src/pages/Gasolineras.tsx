  ...
  cargarDatos();
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
            ...
            <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-3 mt-4 md:mt-5">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        >
                            ...
                            {filtrosAbiertos
                                ? t('gasStations.hideAdvancedFilters', { defaultValue: 'Ocultar filtros' })
                                : t('common.filter', { defaultValue: 'Filtros' })}
                        </button>
                    </div>
                    <button
